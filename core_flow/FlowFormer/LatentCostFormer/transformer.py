...
from utils_former.utils import coords_grid, bilinear_sampler, upflow8
...
class FlowFormer(nn.Module):
    ...
    def forward(self, image1, image2, output=None, flow_init=None):
        ...
        cost_memory, feat_s, feat_t = self.memory_encoder(image1, image2, data, context)
        flow_predictions = self.memory_decoder(cost_memory, context, data, flow_init=flow_init)
        return flow_predictions, feat_s, feat_t
